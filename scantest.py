...
if __name__ == "__main__":
    ...
    if wordlist not in ["payloads.txt", "files.txt", "vulnerabilities.txt"]:
        print("Invalid wordlist file. Please select one of the following: payloads.txt, files.txt, vulnerabilities.txt")
        exit()
